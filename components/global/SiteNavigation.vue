<template>
  <div class="c-site-navigation">
          ...
          <div class="w-full h-full grid place-content-center">
            <div class="flex flex-col gap-5 items-center">
              <template v-for="item in navigation">
                <NuxtLink class="text-center" :to="item.url" @click="isOverlayOpen = false">
                  <span class="uppercase text-7xl font-bold"> {{ item.title }} </span>
                </NuxtLink>
              </template>
            </div>
    ...
    <div
      class="flex w-full bg-background dark:bg-dark-background md:px-10 px-5 py-5 md:py-8"
    ...
    >
      ...
      <div class="flex items-center">
        <div
          class="c-site-navigation__menu group relative ml-10 w-10 h-10 flex items-center justify-end py-3 cursor-pointer z-50"
...
.t-menu-overlay-leave-active {
  @apply duration-[2000ms] ease-in-out;
}
...
.t-menu-overlay-leave-active ~ .t-menu-overlay__cover {
  @apply block;
  animation: t-menu-overlay__cover--part-1 2000ms forwards;
}
.t-menu-overlay-enter-active ~ .t-menu-overlay__cover {
  @apply block;
  animation: t-menu-overlay__cover--part-2 1000ms forwards;
}
